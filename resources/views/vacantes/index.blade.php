...
@section('content')
    ...
    @if ($vacantes->count() > 0)
        <div class="flex flex-col mt-10 vacantesGuia">
    ...
    {{ $vacantes->links() }}
    @else
        <p class="text-center text-gray-700 mt-10">No tienes Vacantes Registradas aun</p>
    @endif
...
@section('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const paginate = document.querySelector('.vacantesGuia + nav');
